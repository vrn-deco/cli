...
export function isSet<T extends unknown>(o: unknown): o is Set<T> {
  return getType(o) === 'Set'
}

export function isMap<K extends unknown, V extends unknown>(o: unknown): o is Map<K, V> {
...
export function isAsyncFunction<T extends (...args: never) => Promise<unknown>>(
  o: unknown,
): o is T {
